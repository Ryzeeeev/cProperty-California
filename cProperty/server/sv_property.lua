...
ESX = nil
TriggerEvent('::{korioz#0110}::esx:getSharedObject', function(a)
    ESX = a 
end)
...
AddEventHandler("cProperty:Actualizes", function()
    ...
    function(result)
        ...
        print("[^2Property^7] Les maisons sont bien sauvegarder")
...
AddEventHandler('ESX:SavePlayer', function()
	...
	if not Server.InstancePlayer[xPlayer.identifier] then 
